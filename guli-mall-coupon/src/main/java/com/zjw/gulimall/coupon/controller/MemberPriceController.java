...
public class MemberPriceController {
    ...
    @PostMapping("/save/bacth")
    public R saveBatch(@RequestBody List<MemberPriceEntity> memberPriceEntityList){
        if(memberPriceEntityList != null && memberPriceEntityList.size() > 0){
